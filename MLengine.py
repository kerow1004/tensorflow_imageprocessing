...
global listDir
if len(os.listdir('./text_bin_file')) != 3:
    listDir = ['./text_bin_file/words_set.bin', './text_bin_file/word_dict.bin', './text_bin_file/category_dict.bin']
else:
    listDir = os.listdir('./text_bin_file')
